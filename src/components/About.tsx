...
export function About() {
    return (
        <section className=" flex flex-col items-center justify-center py-20 px-4 responsive-section-about w-full" style={{backgroundImage:"url('./bannersec2.png')", backgroundRepeat:"no-repeat", backgroundPosition:"center", backgroundSize:"cover"}}>
